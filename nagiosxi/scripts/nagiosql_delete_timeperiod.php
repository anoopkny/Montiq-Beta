...
$cmdline="/usr/bin/wget --load-cookies=".$cookiefile." ".$url." --no-check-certificate --post-data 'type=timeperiod&backend=1&cmd=delete&id=".$id."' -O nagiosql.delete.timeperiod";
echo "CMDLINE:\n";
echo $cmdline;
echo "\n";
