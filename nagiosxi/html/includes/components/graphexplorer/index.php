...
<script type="text/javascript">
    ...
    function ge_display_dashlet_created() {
        ...
        display_child_popup();
        $('#child_popup_layer').css('height', '80px'); // Overrideing built in resizing
    ...
    function ge_add_graph_to_dashlet() {
        ...
        $.post("dashifygraph.php", {url: hiddenurl, dashletName: dashletname, boardName: board}, function (data) {
...
<div id="tabs" class="ui-tabs ui-widget ui-widget-content">
    <ul class="ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header">
        <li class="ui-state-default ui-tabs-active ui-state-active">
            <a class="ui-tabs-anchor" id='showBar' href='javascript:setType("bar"); javascript:fetch_bar(); javascript:toggle_filter();' title="Shows the top alert producers for the last 24 hours">
                <?php echo _("Top Alert Producers"); ?>
            </a>
        </li>
        <li class="ui-state-default">
            <a class="ui-tabs-anchor" id='showPieHost' href='javascript:setType("pie"); javascript:fetch_pie("hosthealth"); javascript:toggle_filter();' title="Shows host health percentage as a pie graph.">
                <?php echo _("Host Health"); ?>
            </a>
        </li>
        <li class="ui-state-default">
            <a class="ui-tabs-anchor" id='showPieService' href='javascript:setType("pie"); javascript:fetch_pie("servicehealth"); javascript:toggle_filter();' title="Shows service health percentage as a pie graph.">
                <?php echo _("Service Health"); ?>
            </a>
        </li>
        <li class="ui-state-default">
            <a class="ui-tabs-anchor" id='showTimeline' href='javascript:setType("timeline"); javascript:toggle_filter("timeline");' title="Shows performance data on a scalable timeline.">
                <?php echo _("Scalable Performance Graph"); ?>
            </a>
        </li>
        <li class="ui-state-default">
            <a class="ui-tabs-anchor" id='showStack' href='javascript:setType("stack"); javascript:toggle_filter("stack");' title="Shows performance data with overlapping timeperiods for comparison.">
                <?php echo _("Time Stacked Performance Graph"); ?>
            </a>
        </li>
        <li class="ui-state-default">
            <a class="ui-tabs-anchor" id='showObjectStack' href='javascript:setType("multistack"); javascript:toggle_filter("multistack");' title="Multistacked performance data with overlapping services and/or hosts for comparison.">
    ...
    <div class="divtable-column" id="leftContainer" style="width: 20%; display: none;">
        ...
        <div id="host_service_selection">
            ...
            <div style="margin-bottom: 6px;">
                ...
                <select name='selectService' id='selectService' style="width: auto; max-width: 320px;" class="form-control">
