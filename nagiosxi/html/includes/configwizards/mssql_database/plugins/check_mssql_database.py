...
#
# Adjusted 01/09/2014 to fix datasize to not report Log Growth, additionally fix BASE_QUERY & DIVI_QUERY
# as per http://support.nagios.com/forum/viewtopic.php?f=16&t=21791#p76891 -SW
# Modified 01/22/2015 Removed extraneous ';' in output. -BD-G
########################################################################
