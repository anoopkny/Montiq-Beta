...
#linux-server configwizard sanity check
...
do_these_files_exist $WIZARDS/linux-server/linux-server.inc.php $LIBEXEC/check_nrpe $LIBEXEC/check_icmp

is_wizard $WIZARDS/linux-server/linux-server.inc.php
