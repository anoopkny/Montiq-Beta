...
# Contributor(s): Patrick Müller, Jeremy Martin, Eric Jonsson, stumpr, John Cavanaugh, Libor Klepac, Scott Wilkerson
#
# Modified 10/12/2015 to use Nagios::Monitoring::Plugin - Scott Wilkerson
#
...
} or Nagios::Monitoring::Plugin::Functions::nagios_exit('UNKNOWN', "Missing perl module VMware::VIRuntime. Download and install \'VMware Infrastructure (VI) Perl Toolkit\', available at http://www.vmware.com/download/sdk/\n $perl_module_instructions");
