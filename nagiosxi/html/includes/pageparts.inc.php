...
?>
    ...
    var lang = {
        ...
        'Thanks for helping to make this product better! We will review your comments as soon as we get a chance. Until then, kudos to you for being awesome and helping drive innovation!<br><br> - The Dedicated Team @ Nagios Enterprises': "<?php echo encode_form_val(_('Thanks for helping to make this product better! We will review your comments as soon as we get a chance. Until then, kudos to you for being awesome and helping drive innovation!<br><br> - The Dedicated Team @ Nagios Enterprises')); ?>",
        ...
        'Use this to add a new dashboard to your <b>Dashboards</b> page.': "<?php echo encode_form_val(_('Use this to add a new dashboard to your <b>Dashboards</b> page.')); ?>",
        ...
        'Use this to add what you see on the screen to your <b>Views</b> page.': "<?php echo encode_form_val(_('Use this to add what you see on the screen to your <b>Views</b> page.')); ?>",
        'View Title': "<?php echo encode_form_val(_('View Title')); ?>",
        'View Added': "<?php echo encode_form_val(_('View Added')); ?>",
        'Success! Your view was added to your <b>Views</b> page.': "<?php echo encode_form_val(_('Success! Your view was added to your <b>Views</b> page.')); ?>",
